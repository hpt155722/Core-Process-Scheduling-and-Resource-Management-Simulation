...
// Global Variables
// Define structures to represent events and processes
struct event
{
    int processNumber;
    string resourceReq;
...
// Declare global variables for tracking system state
int nUsedCores;
int nFreeCores;
...
vector<int> locks; // 0 represents unused, 1 represents in use
int ssd = 0; // 0 represents unused, 1 represents in use
vector<event> waitingQueue;

// Function to check if all process queues are empty
...
// Function to sort a vector of events based on start time
...
// Function to handle the CPU event
